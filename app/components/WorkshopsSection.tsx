  ...
  return (
    <>
      <section id="workshops" className="flex flex-col md:flex-row w-full md:aspect-[2/1]">
        ...
        <div className="w-full aspect-square md:w-1/2 md:h-full md:aspect-square flex justify-center items-center bg-oczko-violet-100 border-r-[0.5px] border-b-[0.5px] border-neutral-800">
            <HeroCarousel images={heroImages} />
        </div>
      </section>

      <section className="flex flex-col md:flex-row w-full md:aspect-[2/1]">
        <article className="w-full aspect-square md:w-1/2 md:h-full md:aspect-square flex flex-col justify-center items-center bg-oczko-orange-400 border-r-[0.5px] border-b-[0.5px] border-neutral-800">
        ...
        <div className="w-full aspect-square md:w-1/2 md:h-full md:aspect-square flex justify-center items-center bg-oczko-green-100 border-r-[0.5px] border-b-[0.5px] border-neutral-800">

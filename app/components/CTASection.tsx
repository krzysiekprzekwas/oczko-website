...
export function CTASection({ backgroundColor = "bg-oczko-violet-300" }: CTASectionProps) {
  return (
    <section className="flex flex-wrap items-center w-full max-md:max-w-full">
      <article className="flex overflow-hidden flex-col grow shrink justify-between self-stretch py-16 pr-7 pl-10 w-96 bg-oczko-violet-500 border-r-[0.5px] border-b-[0.5px] border-neutral-800 min-h-[480px] min-w-60 text-oczko-violet-100 max-md:px-5 max-md:max-w-full">
      ...
      <div className="flex overflow-hidden flex-col grow shrink justify-center self-stretch px-10 py-16 my-auto w-96 bg-white border-r-[0.5px] border-b-[0.5px] border-neutral-800 min-h-[480px] min-w-60 max-md:px-5 max-md:max-w-full">

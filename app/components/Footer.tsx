...
export function Footer() {
  return (
    <footer
      ...
      id="contact"
    >
      <div className="flex flex-col grow shrink justify-center items-center self-stretch px-10 py-4 w-96 bg-oczko-violet border-solid border-[0.5px] border-neutral-800 min-h-40 min-w-60 max-md:px-5 max-md:max-w-full">
        <img
      ...
      <nav className="flex flex-col grow shrink items-start self-stretch px-10 py-4 w-96 text-xs leading-tight uppercase bg-oczko-violet border-solid border-[0.5px] border-neutral-800 min-h-40 min-w-60 text-stone-50 max-md:px-5 max-md:max-w-full">
      ...
      <div className="flex flex-col grow shrink justify-center self-stretch px-10 py-4 w-96 bg-oczko-violet border-solid border-[0.5px] border-neutral-800 min-h-40 min-w-60 text-stone-50 max-md:px-5 max-md:max-w-full">
        <div className="flex flex-col flex-1 justify-center w-full">
          ...
          <div className="flex gap-1 items-center p-2 max-w-full text-xs leading-tight uppercase">
            <span className="self-stretch my-auto text-stone-50">

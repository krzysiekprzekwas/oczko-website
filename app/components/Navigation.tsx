...
export function Navigation() {
  return (
    <header className="sticky top-0 z-50 flex flex-wrap gap-10 justify-between items-center px-10 w-full text-indigo-800 bg-orange-50 border-solid border-[0.5px] border-neutral-800 min-h-20 max-md:px-5 max-md:max-w-full">
